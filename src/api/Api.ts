...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  taxs = {
     ...
     * @secure
     */
    taxsUpdateCodeUpdate: (taxId: string, codeId: string, data: CodeTax, params: RequestParams = {}) =>
  ...
  users = {
     ...
     * @secure
     */
    usersSearchList: (params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/users/search/`,
        method: "GET",
        secure: true,
     ...
     *
     * @tags users
     * @name UsersMakeAdminUpdate
     * @request PUT:/users/{user_id}/make_admin/
     * @secure
     */
    usersMakeAdminUpdate: (userId: string, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/users/${userId}/make_admin/`,
        method: "PUT",
        secure: true,
        ...params,
      }),
